...
#include "m_dNtOOKQMgp6RgLIBCfstNE.h"
...
static void cgxe_mdl_start(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance, const emlrtStack *sp);
static int8_T mw__internal__call__step(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance, const emlrtStack *sp);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
...
static int32_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_dNtOOKQMgp6RgLIBCfstNE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S, int_T tid)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S, int_T tid)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
  InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *moduleInstance =
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE *)calloc(1, sizeof
    (InstanceStruct_dNtOOKQMgp6RgLIBCfstNE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_dNtOOKQMgp6RgLIBCfstNE);
  ssSetmdlInitializeConditions(S, mdlInitialize_dNtOOKQMgp6RgLIBCfstNE);
  ssSetmdlUpdate(S, mdlUpdate_dNtOOKQMgp6RgLIBCfstNE);
  ssSetmdlTerminate(S, mdlTerminate_dNtOOKQMgp6RgLIBCfstNE);
  ssSetmdlEnable(S, mdlEnable_dNtOOKQMgp6RgLIBCfstNE);
  ssSetmdlDisable(S, mdlDisable_dNtOOKQMgp6RgLIBCfstNE);
...
static void mdlProcessParameters_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S)
{
}

void method_dispatcher_dNtOOKQMgp6RgLIBCfstNE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_dNtOOKQMgp6RgLIBCfstNE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_dNtOOKQMgp6RgLIBCfstNE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_dNtOOKQMgp6RgLIBCfstNE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_dNtOOKQMgp6RgLIBCfstNE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: dNtOOKQMgp6RgLIBCfstNE.\n"
...
mxArray *cgxe_dNtOOKQMgp6RgLIBCfstNE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_dNtOOKQMgp6RgLIBCfstNE_fallback_info(void)
{
