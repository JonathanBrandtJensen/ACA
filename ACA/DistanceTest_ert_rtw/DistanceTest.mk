###########################################################################
## Makefile generated for Simulink model 'DistanceTest'. 
## 
## Makefile     : DistanceTest.mk
## Generated on : Thu Nov 22 11:53:49 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DistanceTest
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Lenovo/Documents/MATLAB/ACA
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = DistanceTest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DistanceTest
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/DistanceTest_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(EV3_LMSTYPES_DIR)/.. -I$(EV3_LMS2012_DIR)/.. -I$(EV3_BYTECODES_DIR)/.. -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=DistanceTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = DistanceTest.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_infrared_sensor.o driver_ev3_motor.o driver_ev3_ultrasonic_sensor.o
...
%.o : $(START_DIR)/DistanceTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/DistanceTest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
driver_ev3_infrared_sensor.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/ev3/src/driver_ev3_infrared_sensor.c
	$(CC) $(CFLAGS) -o $@ $<
...
driver_ev3_ultrasonic_sensor.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/ev3/src/driver_ev3_ultrasonic_sensor.c
	$(CC) $(CFLAGS) -o $@ $<
